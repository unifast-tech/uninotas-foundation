...
| --- | --- | --- | --- | --- | --- |
| Foundation UniNotas cutover | `main@53ac1dd` | `n/a — main-only authority` | `n/a` | `origin/main@53ac1dd` | R8Q material review-baseline evidence only; not delivery promotion |
...
| Git remote Foundation | necessário para baseline de revisão | healthy | 2026-09-25 | `main`/`origin/main@53ac1dd`; baseline material R8Q publicada; guard main-only instalado e Git for Windows é o writer válido | nenhum ajuste |
...
- **Baseline commit:** `53ac1dde8769112b812509b90e82ceb32e316097`
- **Baseline push reference:** `origin/main`
- **Gate status:** `findings_integrated`
- **Findings summary:** os achados R8P foram integrados e a baseline material R8Q imutável foi publicada somente como evidência de revisão.
- **Evidence / reference:** `origin/main@53ac1dd`; merges derivados `uninotas-r8p-architecture-merge.json` e `uninotas-r8p-critique-merge.json`; dual-set, remote-tip real e consumer binding R8P integrados.
...
- **Gate status:** `not_run`
- **Findings summary:** baseline material R8Q publicada; arquitetura/crítica R8Q e o guard de drift ainda não foram concluídos.
- **Evidence / reference:** freeze `origin/main@53ac1dde8769112b812509b90e82ceb32e316097`; este SHA deve ser exatamente o consumido pelo drift guard após convergência.
- **Waiver authority / reference:** `n/a`
