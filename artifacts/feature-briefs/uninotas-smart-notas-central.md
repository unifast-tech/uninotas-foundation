...
| `ST-02` | Redefine the product canonically as UniNotas and correct the source topology | project-level strategic authority | all modules | Mandate, constitution, roadmap, entities, scope policy, and modules agree on FastPay, n8n, Smart Notas, PostgreSQL, and UniNotas responsibilities | Foundation validation and decision review | `defer` | `ST-01`, including identifier and ownership decisions | No runtime implementation |
