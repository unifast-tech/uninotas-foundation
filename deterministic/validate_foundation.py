...
def ledger_entries(tree, todo_path, expected_lifecycle, errors):
    ...
    try:
        ...
        actual, rows = section_occurrences(tree[todo_path].read_text(encoding="utf-8")), {}
